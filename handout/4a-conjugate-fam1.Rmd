...
Let $f(\theta)$ be a prior distribution for parmaeter $\theta$ from a particular distribution, and $L(\theta|x)$ be the likelihood function for the data conditional on parameter $\theta$, with its own particular distribution as the basis of the likelihood.
